...
import type { FormState as BaseFormState } from '@/lib/types';


export interface FormState extends BaseFormState {
    propertyId?: string;
}
...
export async function updatePropertyAction(
    ...
    try {
        ...
        await firestore.runTransaction(async (transaction) => {
            ...
            // This is a simple upsert logic. A more robust solution might handle unit deletions.
            units.forEach(unit => {
